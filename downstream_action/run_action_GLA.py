...
from downstream_action.datasets_action import build_dataset
from downstream_action.engine_for_action import (
    train_one_epoch,
...
def get_args():
    parser = argparse.ArgumentParser(
        "SurgPETL fine-tuning and evaluation script for video classification", 
        add_help=False,
    )
    ...
    parser.add_argument("--num_sample", type=int, default=1, help="Repeated_aug (default: 2)")
    parser.add_argument(
        "--aa",
        type=str,
...
def main(args, ds_init):
    ...
    if args.eval:
        ...
        test_stats = final_action_test(data_loader_test, model, device, preds_file)
