...
import model.modeling_phase_finetune_dualpath_timm
...
def get_args():
    ...
    parser.add_argument(
        "--model",
        default="vit_base_224_dual_path",
        type=str,
        metavar="MODEL",
    ...
    parser.add_argument(
        "--pretrained_data",
        default="surgery",
        choices=["imagenet21k", "wit400m_in12k", "wit400m", "laion2b_in12k", "laion2b", "laion400m", "k400", "k600", "howto100m", "surgery"],
        type=str,
        help="dataset",
    )
    ...
    parser.add_argument("--attn_divided", action="store_true", default=False)
    ...
    parser.add_argument(
        "--data_path",
        default="/home/yangshu/SurgVideoMAE/data/cholec80",
        type=str,
        help="dataset path",
    )
    parser.add_argument(
    ...
    parser.add_argument("--data_strategy", type=str, default="online")  # online/offline
    parser.add_argument(
        "--output_mode", type=str, default="key_frame"
    )  # key_frame/all_frame
    parser.add_argument("--cut_black", default=False, action="store_true")  # True/False
    parser.add_argument("--num_frames", type=int, default=8)
    parser.add_argument(
        "--sampling_rate", type=int, default=2
    ...
    parser.add_argument(
        "--output_dir",
        default="/home/yangshu/SurgVideoMAE/Cholec80/ImageNet/phase_video_petl_aim/",
...
def main(args, ds_init):
    ...
    dataset_train, args.nb_classes = build_dataset(
        is_train=True, test_mode=False, fps=args.train_data_fps, args=args
    ...
    if args.disable_eval_during_finetuning:
        ...
        dataset_val, _ = build_dataset(
            is_train=False, test_mode=False, fps=args.test_data_fps, args=args
        )  # Cholec80第41-48视频序列用于验证集：535933
    dataset_test, _ = build_dataset(
        is_train=False, test_mode=True, fps=args.test_data_fps, args=args
    ...
    if args.pretrained_data == "imagenet21k":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_augreg_in21k.bin"
            args.qkv_divided = False
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch16_224_augreg_in21k.bin"
            args.qkv_divided = False
            args.qkv_bias = True
    elif args.pretrained_data == "wit400m_in12k":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_wit400m_ftin12k.bin"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 14:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch14_224_wit400m_ftin12k.bin"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
    elif args.pretrained_data == "wit400m":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_wit400m.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 14:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch14_224_wit400m.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
    elif args.pretrained_data == "laion2b_in12k":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_laion2b_ftin12k.bin"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 14:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch14_224_laion2b_ftin12k.bin"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
    elif args.pretrained_data == "laion400m":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_laion400m.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 14:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch14_224_laion400m.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
    elif args.pretrained_data == "laion2b":
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_laion2b.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
        elif "large" in args.model and args.patch_size == 14:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch14_224_laion2b.pth"
            args.qkv_divided = False
            args.pre_norm = True
            args.qkv_bias = True
    # 手术数据预训练模型
        ...
        if "base" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_base_patch16_224_surgery.pth"
            args.qkv_divided = True
            args.surgery = True
        elif "large" in args.model and args.patch_size == 16:
            pretrained_path = "/home/syangcw/PETL4SurgVideo/pretrain_params/vit_large_patch16_224_surgery.pth"
            args.qkv_divided = True
            args.surgery = True
    ...
    model = create_model(
        ...
        attn_divided=args.attn_divided,
    ...
    txt_file.write("number of params:" + str(n_parameters))
    txt_file.close()
    ...
    if mixup_fn is not None:
        ...
        #     weight=torch.from_numpy(weights_train).float().cuda()
        # )
        criterion = torch.nn.CrossEntropyLoss()
