...
from model import modeling_phase_finetune_timesformer
...
def get_args():
    ...
    parser.add_argument("--patch_size", default=14, type=int, help="videos patch size")
